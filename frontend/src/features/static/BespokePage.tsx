...
const processSteps = [
  {
    ...
    title: '1. Curate Your Image',
    description: 'Upload a cherished photograph, a piece of original artwork, or a memorable map. Our design team will review it for resolution and composition to ensure a stunning final piece.'
  },
  {
    icon: <Scissors className="w-6 h-6 text-primary" />,
    title: '2. The Artisan Cut',
    description: 'We do not use standard grid patterns. Our master designers map a custom cut path for your image, including personalized "whimsy" pieces shaped like animals, initials, or objects meaningful to you.'
  },
  {
    icon: <Paintbrush className="w-6 h-6 text-primary" />,
    title: '3. Crafting & Finishing',
    description: 'Your image is infused into 1/4-inch premium maple wood. Our precision lasers cut the intricate design, and each piece is carefully hand-inspected and gently cleaned.'
  },
  {
    icon: <Package className="w-6 h-6 text-primary" />,
    title: '4. The Unboxing',
    description: 'Your bespoke puzzle arrives in a handcrafted wooden box, wrapped in protective parchment, complete with a wax seal—ready for gifting or a timeless family evening.'
  }
];
    ...
    <div className="min-h-screen bg-surface text-on-surface">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <Motion preset="up" className="space-y-6">
            ...
            <p className="font-body-lg text-on-surface-variant max-w-2xl mx-auto leading-relaxed text-lg md:text-xl">
              Commission a one-of-a-kind wooden jigsaw puzzle. Transform a special moment into an heirloom that will be pieced together for generations.
            </p>
      ...
      <section className="py-24 bg-surface">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Motion preset="up" className="text-center mb-16">
            <h2 className="font-display-md text-3xl md:text-4xl text-on-surface">The Atelier Process</h2>
            <p className="text-on-surface-variant mt-4 max-w-2xl mx-auto">
              Every custom piece goes through our rigorous, four-step artisanal workflow to ensure perfection.
            </p>
          </Motion>
      ...
      <section className="py-24 border-t border-outline-variant/30 bg-surface-container-lowest">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <Motion preset="up">
            <h2 className="font-display-md text-3xl mb-4">Have Questions?</h2>
            <p className="text-on-surface-variant mb-8">
              Learn more about our materials, shipping, and return policies in our detailed FAQ.
            </p>
            <Link 
              to="/faq" 
