...
import { listProductsHandler, listCategoriesHandler, listAllProductsAdminHandler, getProductHandler, createProductHandler, updateProductHandler, deleteProductHandler, } from "./product.controller.js";
const router = Router();
// Public
