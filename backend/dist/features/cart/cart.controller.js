import { objectId, validateCartSchema, addItemSchema, updateItemSchema, mergeCartSchema, } from "./cart.validation.js";
import { getCart, addItem, updateItemQuantity, removeItem, mergeGuestCart, validateCartItems, } from "./cart.service.js";
...
function getProductIdParam(req) {
...
export async function mergeCartHandler(req, res, next) {
    try {
